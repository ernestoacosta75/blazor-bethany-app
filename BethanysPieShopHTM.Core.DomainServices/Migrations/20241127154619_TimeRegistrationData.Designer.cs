...
namespace BethanysPieShopHTM.Core.DomainServices.Migrations
{
    ...
    [Migration("20241127154619_TimeRegistrationData")]
            ...
            modelBuilder.Entity("BethanysPieShopHRM.Shared.Domain.TimeRegistration", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EmployeeId = 1,
                            EndTime = new DateTime(2024, 10, 2, 13, 6, 22, 0, DateTimeKind.Unspecified),
                            PerformedTaskDescription = "Task 1",
                            StartTime = new DateTime(2024, 7, 1, 23, 42, 16, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            TimeRegistrationId = 2,
                            EmployeeId = 1,
                            EndTime = new DateTime(2024, 8, 11, 14, 38, 40, 0, DateTimeKind.Unspecified),
                            PerformedTaskDescription = "Task 2",
                            StartTime = new DateTime(2024, 1, 3, 22, 18, 59, 0, DateTimeKind.Unspecified)
                        });
                });
